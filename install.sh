...
mkdir -p "$MASTODON_PATH/app/javascript/matrix"
mkdir -p "$MASTODON_PATH/public/matrix"
mkdir -p "$MASTODON_PATH/public/emoji/custom"

echo "🎨 Installing theme SCSS..."
cp "$THEME_DIR/styles/errordon_matrix.scss" "$MASTODON_PATH/app/javascript/styles/errordon_matrix.scss"

echo "💻 Installing JavaScript..."
cp "$THEME_DIR/js/matrix_theme.ts" "$MASTODON_PATH/app/javascript/mastodon/features/matrix/"
cp "$THEME_DIR/js/matrix_rain.js" "$MASTODON_PATH/app/javascript/matrix/index.js"
cp "$THEME_DIR/js/matrix_background.js" "$MASTODON_PATH/app/javascript/matrix/"
